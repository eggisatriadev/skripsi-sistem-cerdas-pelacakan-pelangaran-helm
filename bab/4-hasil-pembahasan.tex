...
Pembacaan distribusi pada Tabel~\ref{tab:distribusi-objek} difokuskan pada dua kelas pelanggaran yang menjadi inti penelitian, yaitu \texttt{DRIVER\_HELMET} sebanyak 730 anotasi dan \texttt{DRIVER\_NO\_HELMET} sebanyak 718 anotasi. Selisih antara keduanya hanya 12 anotasi atau setara rasio 1{,}02:1, sehingga dapat dianggap setara. Keseimbangan tersebut menjadi syarat utama agar model tidak cenderung memilih salah satu kategori saat membedakan pengendara berhelm dan tanpa helm. Kelas \texttt{MOTORCYCLE} memuat 921 anotasi atau lebih banyak sekitar 191 hingga 203 anotasi dibandingkan dua kelas pelanggaran. Selisih tersebut wajar karena \texttt{MOTORCYCLE} berperan sebagai kelas konteks; badan kendaraan tampak utuh pada hampir setiap citra, sedangkan area kepala pengendara kerap terhalang sebagian oleh helm proyektor, kaca depan, atau penumpang sehingga jumlah anotasinya sedikit lebih rendah.

Penilaian keseimbangan tersebut sejalan dengan ambang yang lazim dipakai pada literatur deteksi objek. Survei oleh \cite{johnson2019imbalance} menyebutkan rasio antara kelas mayoritas dan minoritas yang masih berada di kisaran 1,5:1 hingga 4:1 tergolong ketidakseimbangan ringan dan tidak menuntut penanganan khusus pada saat pelatihan. Studi empiris \cite{buda2018systematic} pada jaringan konvolusi menunjukkan bahwa strategi pengimbangan, seperti \textit{oversampling} atau \textit{focal loss}, baru memberikan dampak signifikan ketika rasio melampaui 1:10. Tinjauan menyeluruh \cite{oksuz2020imbalance} juga menempatkan dataset deteksi objek pada kategori bermasalah hanya jika rasio antar-kelas melampaui satu order magnitudo. Pada penelitian ini, rasio kelas mayoritas (\texttt{MOTORCYCLE}) terhadap kelas minoritas (\texttt{DRIVER\_NO\_HELMET}) sebesar 921:718 atau 1,28:1, jauh di bawah ambang yang disebutkan. Distribusi ketiga kelas dengan demikian tergolong seimbang sehingga risiko bias model ke kelas mayoritas dapat dikatakan rendah.
